...
}), define("onboard/paths", [], function() {
  return{
    APP : "//www.ryflection.com/next/embed/onboard.bundle.acb5cc31dd9945f747781741d77c3ca0.js".slice(0, -3),
    STYLES : "//www.ryflection.com/next/embed/styles/onboard.2506c1ec14ef8f1458ce7e1a5c25b41e.css",
    RTL_STYLES : "//www.ryflection.com/next/embed/styles/onboard_rtl.8e4c4b668a1e7a0802e1803103266a67.css"
  };
  ...
  me.init = function(depMaps, factory) {
    ...
    function init() {
      ...
      jQuery(["jquery", depMaps + "/main", "loglevel", "raven", "remote/config"], function(options, data, enemy, Raven, dataAndEvents) {
        ...
        Raven.config(config, {
          whitelistUrls : ["//ryflection/static"],
          release : me.version,
          /**
           * @return {?}
           */
...
}), define("onboard.load", function() {
}), require(["onboard/paths", "common/main"], function(callback, _super) {
  _super.init("onboard", callback);
});
