define("discovery/exceptions", [], function() {
  ...
  var AdvertisementCollection = Class.extend({
    url : "//tempest.services.reflect.com/listPromoted",
    /**
     * @param {?} contentHTML
     * @param {Object} options
     * @return {undefined}
    ...
    getDataPromoted : function() {
      ...
      if (self.get("preview")) {
        if (self.has("previewQueryParam")) {
          self.ads.url = "//tempest.services.ryflection.com/preview/serve/" + self.get("previewQueryParam");
        }
      }
      var params = {
        timeout : timedout,
...
}), define("discovery.bundle", function() {
});
